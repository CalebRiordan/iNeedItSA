    ...
    <div class="right <?= $SessionUser ? 'show-mobile-sidebar' : '' ?>">
        <ul>
            <?php if ($SessionUser): ?>
                <?php $SessionUser ?>
                <li>
                    <a class="nav-link" href="/logout"><span class="nav-text">Logout</span></a>
                </li>
                <li>
                    ...
                    --><a class="nav-link" href="/order#cart"><span class="nav-text alternative">Cart</span></a>
                </li>
                <li>
                    <a class="nav-link user-profile">
                        ...
                        <?php endif; ?>
                        <a class="nav-link" href="/profile/edit"><span class="nav-text alternative">Edit Profile</span></a>
                    </a>
                </li>
            <?php else: ?>
                <li>
